...
// --------------------- Capability events --------------------- //
    ...
    @Override
    public void productStockConnected(String productCode, String stockCode) {
        log.atInfo()
                .addKeyValue("category", LogCategory.EVENT)
                .addKeyValue("type", EventType.BUSINESS)
                .addKeyValue("domain", SystemDomain.PRODUCT)
                .addKeyValue("event", BusinessEvent.PRODUCT_STOCK_LINKED)
                .addKeyValue("productCode", productCode)
                .addKeyValue("stockCode", stockCode)
                .log("product stock linked");
    }

    @Override
    public void productPublished(String productCode) {
        log.atInfo()
                .addKeyValue("category", LogCategory.EVENT)
                .addKeyValue("type", EventType.BUSINESS)
                .addKeyValue("domain", SystemDomain.PRODUCT)
                .addKeyValue("event", BusinessEvent.PRODUCT_PUBLISHED)
                .addKeyValue("productCode", productCode)
                .log("product published");
    }

    @Override
    public void productUnpublished(String productCode) {
        log.atInfo()
                .addKeyValue("category", LogCategory.EVENT)
                .addKeyValue("type", EventType.BUSINESS)
                .addKeyValue("domain", SystemDomain.PRODUCT)
                .addKeyValue("event", BusinessEvent.PRODUCT_UNPUBLISHED)
                .addKeyValue("productCode", productCode)
                .log("product unpublished");
    }
